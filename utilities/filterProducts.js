class filterProducts {
    ...
    searchQuery = () => {
        this.products = this.query.searchValue ? this.products.filter(c => c.name.toUpperCase().indexOf(this.query.searchValue.toUpperCase()) > -1) : this.products
        return this
    }
    ...
    priceQuery = () => {
        this.products = this.products.filter(p => p.price >= this.query.min && p.price <= this.query.max)
        return this
    }
    sortByPrice = () => {
